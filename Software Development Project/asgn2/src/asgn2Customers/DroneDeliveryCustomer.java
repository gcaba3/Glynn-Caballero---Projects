...
public class DroneDeliveryCustomer extends Customer {
	...
	public double getDeliveryDistance() {
		double storeLocationY; double storeLocationX; storeLocationX = storeLocationY = 0.0;
		double euclideanDistance = Math.sqrt((Math.pow((storeLocationX - this.getLocationX()), 2)) + (Math.pow((storeLocationY - this.getLocationY()), 2)));
